        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach(function(value, index) {
                    ...
                    var available = 0;
                    if (value.capacity - value.vehicle_in < 0) {
                        available = 0;
                    } else {
                        available = value.capacity - value.vehicle_in;
                    }

                    sensorList += `<div class="col-lg-4 col-md-4 col-sm-12 mt-5">
                            <div class="card text-center">
                                <div class="card-header">
                                    <b>${value.floor}<sup>st</sup> FLOOR</b>
                                </div>
                                <div class="card-body">
