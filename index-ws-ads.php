...
DEFINE("root", "http://" . htmlspecialchars($_SERVER["HTTP_HOST"]) . "/ev-charging-display/");
...
<body>
    <div class="container" id="slide">
        ...
        ?>
            <video id="video-ads" class="header-ads" loop muted autoplay style="rotate: -90deg; display:none;">
            ...
            <!-- <div class="qr-block btn-7" id="qr" style="display:none;">
                ...
                <img src="./images/evcpark2.jpeg" alt="this slowpoke moves" width="60px" height="60px" style="margin-top:65px; margin-left:55px;" />
            </div> -->
...
<script>
    ...
    // const ws = new WebSocket("ws://110.0.50.55:3001/websocket");
